  ...
  constructor(props) {
    ...
    this.state = {
      ...
      list: [
        ...
        { id: 'Bournemouth', name: 'Bournemouth', color: "#cc0000" },
        { id: 'Brentford', name: 'Brentford', color: "#cc0000" },
        ...
        { id: 'Fulham', name: 'Fulham', color: "#3572c2" },
        ...
        { id: 'NottinghamForest', name: 'Nottingham Forest', color: "#f1cf03" },
